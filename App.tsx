                    ...
                    <div className="flex-1 flex gap-6 overflow-hidden p-6">
                        ...
                        <div className={`relative transition-all duration-300 ease-in-out ${isRightSidebarCollapsed ? 'w-0' : 'w-96'}`}>
                            <button
                                ...
                                className="absolute top-1/2 -translate-y-1/2 -left-3 z-10 w-6 h-16 bg-gray-700 hover:bg-gray-600 rounded-l-md flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-gray-500"
                            >
                                <DoubleArrowLeftIcon className={`w-5 h-5 transition-transform duration-300 ${isRightSidebarCollapsed ? 'rotate-180' : ''}`} />
                            </button>
